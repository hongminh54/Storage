...
public class MySQLCropTransferStorage {
    ...
    public void createTransferTable() {
        ...
        try {
            ...
            plugin.getLogger().log(Level.SEVERE, "Unable to create MySQL crop transfer table", ex);
        } finally {
            try {
                if (ps != null) ps.close();
    ...
    public void insertTransfer(CropTransferData transferData) {
        ...
        try {
            ...
            plugin.getLogger().log(Level.SEVERE, "Unable to insert MySQL crop transfer data", ex);
        } finally {
            try {
                if (ps != null) ps.close();
                if (conn != null) conn.close();
    ...
    public List<CropTransferData> getTransferHistory(String playerName, int limit, int offset) {
        ...
        try {
            ...
            plugin.getLogger().log(Level.SEVERE, "Unable to get MySQL crop transfer history", ex);
        } finally {
            try {
                if (rs != null) rs.close();
                if (ps != null) ps.close();
    ...
    public int getTotalTransferCount(String playerName) {
        ...
        try {
            ...
            plugin.getLogger().log(Level.SEVERE, "Unable to get MySQL crop transfer count", ex);
        } finally {
            try {
                if (rs != null) rs.close();
                if (ps != null) ps.close();
    ...
    public List<CropTransferData> getAllTransferHistory(int limit) {
        ...
        try {
            ...
            plugin.getLogger().log(Level.SEVERE, "Unable to get all MySQL crop transfer history", ex);
        } finally {
            try {
                if (rs != null) rs.close();
                if (ps != null) ps.close();
