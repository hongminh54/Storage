...
public class DoubleDropEvent extends BaseEvent {
    ...
    public void onPlayerMine(Player player, String material, int amount) {
        ...
        // Track player participation and bonus
        eventData.addPlayerData(player, bonusAmount);
    ...
    protected void broadcastEventEndChat() {
        ...
        int totalBonus = eventData.getPlayerData().values().stream().mapToInt(Integer::intValue).sum();
