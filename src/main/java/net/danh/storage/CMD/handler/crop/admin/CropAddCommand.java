...
public class CropAddCommand extends CropCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        for (String itemName : items) {
            CropStorageManager.addItemAmount(target, itemName, amount);
        }
    ...
    public String getUsage() {
        return "/cropstorage add <player> <item|*|item1,item2,...> <amount>";
    }

    @Override
    public String getDescription() {
        return "Add crop item amount to player's storage";
    }
}
