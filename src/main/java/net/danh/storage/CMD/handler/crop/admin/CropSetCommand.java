...
public class CropSetCommand extends CropCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        for (String itemName : items) {
            CropStorageManager.setItemAmount(target, itemName, amount);
        }
    ...
    public String getUsage() {
        return "/cropstorage set <player> <item|*|item1,item2,...> <amount>";
    }

    @Override
    public String getDescription() {
        return "Set crop item amount in player's storage";
    }
}
