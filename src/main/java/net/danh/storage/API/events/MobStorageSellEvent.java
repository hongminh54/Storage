...
public class MobStorageSellEvent extends Event implements Cancellable {
    ...
    public MobStorageSellEvent(@NotNull Player player, @NotNull String itemName, int amount, double worthPerItem) {
        this.player = player;
