...
/**
 * Event fired when a player transfers multiple crop items to another player via CropStorage.
 * This event is cancellable.
 */
public class CropStorageMultiTransferEvent extends Event implements Cancellable {
    ...
    /**
     * Creates a new CropStorageMultiTransferEvent.
     *
     ...
     */
    public CropStorageMultiTransferEvent(@NotNull Player sender, @NotNull Player receiver,
